...
public class StartTimerPageTest extends AbstractStaticMessageSourcePageTest {
    ...
    static class TestPageConfiguration {
        @Bean
        @ConfigurationProperties(prefix = "test-start-timer")
    ...
    static class TestController {
        ...
        public TestController(SessionMetadata sessionMetadata) {
            this.sessionMetadata = sessionMetadata;
        }

        @GetMapping("/pathExposingStartTime")
        ModelAndView endpointExposingStartTime() {
            String startTime = Optional.ofNullable(sessionMetadata.getStartTime())
