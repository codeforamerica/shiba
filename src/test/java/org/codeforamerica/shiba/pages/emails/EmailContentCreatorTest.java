...
class EmailContentCreatorTest {
    ...
    void shouldCreateConfirmationEmailFromDemo() {
        ...
        assertThat(emailContent).contains("Within 5 days, your county will determine your childcare assistance case and <strong>send you a letter in the mail</strong>.");
    }
