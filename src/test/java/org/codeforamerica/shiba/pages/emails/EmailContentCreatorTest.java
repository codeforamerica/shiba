...
class EmailContentCreatorTest {
  ...
  void shouldCreateNextStepsEmail() {
    ...
    assertThat(emailContent).contains(
    		...
    		+ "<br><br>The time it takes to review your application can vary. If you haven’t heard back about your application within 7 days, contact Anoka County (555-5555) "
    		+ "and Mille Lacs Band of Ojibwe (222-2222) before you submit another application. <br><br><strong>Need help now?</strong>  <br>"
    		+ "If you are in a mental health crisis, call or text 988. <br><br>To connect with food, housing, medical or other help, you can call 211, or text your zip "
    		+ "code to 898-211, or visit <a href=\"https://www.211.org/\" target=\"_blank\" rel=\"noopener noreferrer\"> 211.org</a>. <br><br>If you need additional "
  ...
  void shouldCreateNextStepsEmailInSpanish() {
	...
	assertThat(emailContent).contains(
		"<html><body><br>Usted envió su solicitud de MNbenefits y Anoka County (555-5555) and Mille Lacs Band of Ojibwe (222-2222) la recibió.<br><br><strong>Que Sigue?</strong><br>Sus próximos pasos en el proceso de solicitud pueden incluir cargar documentos de verificación y estar disponible para llamadas y comunicaciones de su trabajador.<br><br><strong>Cargue sus documentos.</strong><br>¿Quiere enviar documentos o pruebas directamente a su condado o nación tribal?  Vaya a <a href=\"https://mnbenefits.mn.gov/?utm_medium=confirmationemail#later-docs-upload\" target=\"_blank\" rel=\"noopener noreferrer\">MNbenefits.mn.gov</a> y haga clic en \"Cargar documentos\".  Los documentos más solicitados son identificación (ID), recibos de pago de su trabajo o prueba de pérdida reciente de trabajo y prueba de alquiler o costos de alojamiento.<br><br><strong>Permita tiempo para que un trabajador revise su solicitud.</strong><br>Su solicitud y documentos serán revisados por su Anoka County (555-5555) and Mille Lacs Band of Ojibwe (222-2222). Dentro de los próximos 5 días, espere una llamada telefónica o una carta por correo de un trabajador de elegibilidad.<br><br>El tiempo que lleva revisar las solicitudes puede variar. Si no ha recibido respuesta sobre su solicitud dentro de 7 días, comuníquese con Anoka County (555-5555) and Mille Lacs Band of Ojibwe (222-2222) antes de enviar otra solicitud.<br><br><strong>¿Necesita ayuda ahora?</strong><br>Si se encuentra en una crisis de salud mental, llame o envíe un mensaje de texto al 988.<br><br>Para recibir ayuda de alimentos, vivienda, ayuda médica y de otro tipo, puede llamar al 211, o enviar un mensaje de texto con su código postal al 898-211, o visitar <a href=\"https://www.211.org/\" target=\"_blank\" rel=\"noopener noreferrer\">https://www.211.org/</a>.  <br><br>Si necesita ayuda adicional para acceder a los alimentos, comuníquese con la Línea de Ayuda Alimentaria de Minnesota al 888-711-1151 o <a href=\"https://www.hungersolutions.org/\" target=\"_blank\" rel=\"noopener noreferrer\">Hungersolutions.org</a>.<br><br><strong>¿Tienes preguntas?</strong><br>Visite a <a href=\"https://mnbenefits.mn.gov/faq\" target=\"_blank\" rel=\"noopener noreferrer\">MNbenefits en las preguntas frecuentes</a>.</body></html>");
  }
  ...
  void shouldCreateNextStepsEmailForExpeditedCcap() {
	...
	assertThat(emailContent).contains(
		"<html><body><br>You submitted your MNbenefits application and Anoka County (555-5555) and Mille Lacs Band of Ojibwe (222-2222) received it.<br><br><strong>What's Next?</strong><br>Your next steps in the application process may include uploading verification documents and being available for calls and communications from your worker.<br><br><strong>Upload your documents.</strong><br>Do you want to send in documents or proof to your county or Tribal Nation directly? Go to <a href=\"https://mnbenefits.mn.gov/?utm_medium=confirmationemail#later-docs-upload\" target=\"_blank\" rel=\"noopener noreferrer\">MNbenefits.mn.gov</a> and click on ‘Upload Documents’. The most requested documents are identification (ID), paystubs from your job or proof of recent loss of job and proof of rent or shelter costs. <br><br><strong>Allow time for a worker to review.</strong><br>Your application and documents will be reviewed by Anoka County (555-5555) and Mille Lacs Band of Ojibwe (222-2222). Your Child Care Assistance application does not need an interview. Within the next 5 days expect a phone call from an eligibility worker. <br><br>The time it takes to review your application can vary. If you haven’t heard back about your application within 7 days, contact Anoka County (555-5555) and Mille Lacs Band of Ojibwe (222-2222) before you submit another application.<br><br><strong>Need help now?</strong>  <br>If you are in a mental health crisis, call or text 988. <br><br>To connect with food, housing, medical or other help, you can call 211, or text your zip code to 898-211, or visit <a href=\"https://www.211.org/\" target=\"_blank\" rel=\"noopener noreferrer\"> 211.org</a>. <br><br>If you need additional assistance to access food, contact Minnesota Food HelpLine at 888-711-1151 or <a href=\"https://www.hungersolutions.org/\" target=\"_blank\" rel=\"noopener noreferrer\">hungersolutions.org</a>.<br><br><strong>Have other questions?</strong><br>Visit <a href=\"https://mnbenefits.mn.gov/faq\" target=\"_blank\" rel=\"noopener noreferrer\">MNbenefits frequently asked questions</a>. </body></html>");
  }
  ...
  void shouldIncludeLaterDocsRecommendationsInFullConfirmationEmailAndDocUploadEmail() {
    ...
    assertThat(confirmationEmail).contains(
        ...
        + "can vary. <br><br>Expect an eligibility worker to contact you by phone or mail with information "
        + "about your next steps. If you haven’t heard back about your application, know that work "
        + "is still in progress. <br><br>Before you submit another application, contact Anoka County "
        + "(555-5555) and Mille Lacs Band of Ojibwe (222-2222).<br><br><strong>Need help now?</strong>  <br>If "
        + "you are in a mental health crisis, call or text 988. <br><br>To connect with food, housing, "
        ...
        + "<br><br>If you need additional assistance to access food, contact Minnesota Food HelpLine "
