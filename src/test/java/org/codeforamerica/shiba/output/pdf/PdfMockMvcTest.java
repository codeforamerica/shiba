...
public class PdfMockMvcTest extends AbstractShibaMockMvcTest {
  ...
  class CAFandCCAP {
    ...
    class WithPersonalAndContactInfo {
      ...
      @Test
      void shouldMarkWhiteAndWriteToClientReportedFieldWithMiddleEasternOrNorthAfrican() throws Exception {
        selectPrograms("SNAP");
      ...
      @Test
      void shouldMarkUnableToDetermineWithHispanicLatinoOrSpanish() throws Exception {
        selectPrograms("SNAP");
      ...
      void shouldWriteClientReportedWhenOtherRaceOrEthnicitySelected() throws Exception {
        ...
        postExpectingSuccess("raceAndEthnicity",
            Map.of("raceAndEthnicity", List.of("SOME_OTHER_RACE_OR_ETHNICITY"),
      ...
      @Test
      void shouldWriteClientReportedWhenOtherRaceOrEthnicitySelectedAndMENA() throws Exception {
        selectPrograms("SNAP");
        postExpectingSuccess("raceAndEthnicity",
        ...
        var caf = submitAndDownloadCaf();
        assertPdfFieldEquals("CLIENT_REPORTED", "Middle Eastern / N. African / SomeOtherRaceOrEthnicity", caf);
      }
    }
  }
