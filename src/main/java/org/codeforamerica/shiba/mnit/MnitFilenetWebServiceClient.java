...
public class MnitFilenetWebServiceClient {
  ...
  public void send(ApplicationFile applicationFile, County county, String applicationNumber,
    ...
    setPropertiesOnDocument(applicationFile, county, createDocument);
  ...
  private void setPropertiesOnDocument(ApplicationFile applicationFile, County county, CreateDocument createDocument) {
    ...
    CmisPropertyString npi = createCmisPropertyString("NPI", countyMap.get(county).getDhsProviderId());
import org.springframework.beans.factory.annotation.Value;
import org.springframework.retry.annotation.Backoff;
import org.springframework.retry.annotation.Recover;
import org.springframework.retry.annotation.Retryable;
