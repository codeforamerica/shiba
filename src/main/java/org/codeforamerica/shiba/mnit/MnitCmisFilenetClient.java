...
public class MnitCmisFilenetClient {
  ...
  public void send(ApplicationFile applicationFile, RoutingDestination routingDestination,
      String applicationNumber, org.codeforamerica.shiba.output.Document applicationDocument,
      FlowType flowType) {
    ...
    ContentStream contentStream = new ContentStreamImpl(fileName,
        BigInteger.valueOf(documentBytes.length), mimeType, stream);
  ...
  private String generateDocumentDescription(ApplicationFile applicationFile,
      org.codeforamerica.shiba.output.Document applicationDocument, String applicationNumber,
      FlowType flowType) {
