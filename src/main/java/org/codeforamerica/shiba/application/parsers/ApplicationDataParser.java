...
public class ApplicationDataParser {
    ...
    static {
        coordinatesMap.put(WRITTEN_LANGUAGE_PREFERENCES,
                new ParsingCoordinate("languagePreferences", "writtenLanguage"));
        coordinatesMap.put(BASIC_CRITERIA_CERTAIN_POPS,
                new ParsingCoordinate("basicCriteria", "basicCriteria"));
        coordinatesMap.put(MEDICAL_EXPENSES,
                new ParsingCoordinate("medicalExpenses", "medicalExpenses"));
        coordinatesMap
                .put(PAID_BY_THE_HOUR, new ParsingCoordinate("paidByTheHour", "paidByTheHour"));
        coordinatesMap.put(HOURLY_WAGE, new ParsingCoordinate("hourlyWage", "hourlyWage"));
        coordinatesMap.put(HOURS_A_WEEK, new ParsingCoordinate("hoursAWeek", "hoursAWeek"));
        coordinatesMap.put(PAY_PERIOD, new ParsingCoordinate("payPeriod", "payPeriod"));
        coordinatesMap.put(INCOME_PER_PAY_PERIOD,
                new ParsingCoordinate("incomePerPayPeriod", "incomePerPayPeriod"));
        coordinatesMap.put(LAST_THIRTY_DAYS_JOB_INCOME,
                new ParsingCoordinate("lastThirtyDaysJobIncome", "lastThirtyDaysJobIncome"));
        coordinatesMap.put(IS_SELF_EMPLOYMENT,
                new ParsingCoordinate("selfEmployment", "selfEmployment"));
        coordinatesMap.put(WHOSE_JOB_IS_IT,
                new ParsingCoordinate("householdSelectionForIncome", "whoseJobIsIt"));
        coordinatesMap.put(EMPLOYERS_NAME,
                new ParsingCoordinate("employersName", "employersName"));
        coordinatesMap.put(ARE_YOU_WORKING,
                new ParsingCoordinate("employmentStatus", "areYouWorking"));

        coordinatesMap.put(LIVING_SITUATION,
                new ParsingCoordinate("livingSituation", "livingSituation"));

        coordinatesMap.put(HAS_DISABILITY, new ParsingCoordinate("disability", "hasDisability"));

        coordinatesMap
                .put(MAILING_STREET, new ParsingCoordinate("mailingAddress", "streetAddress"));
        coordinatesMap.put(MAILING_CITY, new ParsingCoordinate("mailingAddress", "city"));
        coordinatesMap.put(MAILING_STATE, new ParsingCoordinate("mailingAddress", "state"));
        coordinatesMap.put(MAILING_ZIPCODE, new ParsingCoordinate("mailingAddress", "zipCode"));
        coordinatesMap.put(MAILING_APARTMENT_NUMBER,
                new ParsingCoordinate("mailingAddress", "apartmentNumber"));
        coordinatesMap
                .put(MAILING_COUNTY, new ParsingCoordinate("mailingAddress", "enrichedCounty"));
        coordinatesMap.put(ENRICHED_MAILING_STREET,
                new ParsingCoordinate("mailingAddress", "enrichedStreetAddress"));
        coordinatesMap
                .put(ENRICHED_MAILING_CITY, new ParsingCoordinate("mailingAddress", "enrichedCity"));
        coordinatesMap.put(ENRICHED_MAILING_STATE,
                new ParsingCoordinate("mailingAddress", "enrichedState"));
        coordinatesMap.put(ENRICHED_MAILING_ZIPCODE,
                new ParsingCoordinate("mailingAddress", "enrichedZipCode"));
        coordinatesMap.put(ENRICHED_MAILING_APARTMENT_NUMBER,
                new ParsingCoordinate("mailingAddress", "enrichedApartmentNumber"));
        coordinatesMap.put(ENRICHED_MAILING_COUNTY,
                new ParsingCoordinate("mailingAddress", "enrichedCounty"));
        coordinatesMap.put(USE_ENRICHED_MAILING_ADDRESS,
                new ParsingCoordinate("mailingAddressValidation", "useEnrichedAddress"));

        coordinatesMap.put(HOME_STREET, new ParsingCoordinate("homeAddress", "streetAddress"));
        coordinatesMap.put(HOME_CITY, new ParsingCoordinate("homeAddress", "city"));
        coordinatesMap.put(HOME_STATE, new ParsingCoordinate("homeAddress", "state"));
        coordinatesMap.put(HOME_ZIPCODE, new ParsingCoordinate("homeAddress", "zipCode"));
        coordinatesMap
                .put(HOME_APARTMENT_NUMBER, new ParsingCoordinate("homeAddress", "apartmentNumber"));
        coordinatesMap.put(HOME_COUNTY, new ParsingCoordinate("homeAddress", "enrichedCounty"));
        coordinatesMap.put(ENRICHED_HOME_STREET,
                new ParsingCoordinate("homeAddress", "enrichedStreetAddress"));
        coordinatesMap
                .put(ENRICHED_HOME_CITY, new ParsingCoordinate("homeAddress", "enrichedCity"));
        coordinatesMap
                .put(ENRICHED_HOME_STATE, new ParsingCoordinate("homeAddress", "enrichedState"));
        coordinatesMap
                .put(ENRICHED_HOME_ZIPCODE, new ParsingCoordinate("homeAddress", "enrichedZipCode"));
        coordinatesMap.put(ENRICHED_HOME_APARTMENT_NUMBER,
                new ParsingCoordinate("homeAddress", "enrichedApartmentNumber"));
        coordinatesMap.put(ENRICHED_HOME_COUNTY,
                new ParsingCoordinate("homeAddress", "enrichedCounty"));
        coordinatesMap.put(USE_ENRICHED_HOME_ADDRESS,
                new ParsingCoordinate("homeAddressValidation", "useEnrichedAddress"));

        coordinatesMap.put(GENERAL_DELIVERY_CITY,
                new ParsingCoordinate("cityForGeneralDelivery", "whatIsTheCity"));
        coordinatesMap.put(GENERAL_DELIVERY_ZIPCODE,
                new ParsingCoordinate("cityForGeneralDelivery", "enrichedZipcode"));

        coordinatesMap.put(SELECTED_TRIBAL_NATION,
                new ParsingCoordinate("selectTheTribe", "selectedTribe"));

        coordinatesMap.put(LIVING_IN_TRIBAL_NATION_BOUNDARY,
                new ParsingCoordinate("nationsBoundary", "livingInNationBoundary"));

        coordinatesMap.put(APPLYING_FOR_TRIBAL_TANF,
                new ParsingCoordinate("applyForTribalTANF", "applyForTribalTANF"));

        coordinatesMap.put(NO_PERMANENT_ADDRESS,
                new ParsingCoordinate("homeAddress", "isHomeless"));
        coordinatesMap.put(SAME_MAILING_ADDRESS,
                new ParsingCoordinate("mailingAddress", "sameMailingAddress"));

        coordinatesMap.put(IDENTIFY_ZIPCODE, new ParsingCoordinate("identifyZipcode", "zipCode"));
        coordinatesMap.put(IDENTIFY_COUNTY, new ParsingCoordinate("identifyCounty", "county"));

        coordinatesMap.put(ASSETS, new ParsingCoordinate("liquidAssets", "liquidAssets"));
        coordinatesMap
                .put(INCOME, new ParsingCoordinate("thirtyDayIncome", "moneyMadeLast30Days"));
        coordinatesMap.put(MIGRANT_WORKER,
                new ParsingCoordinate("migrantFarmWorker", "migrantOrSeasonalFarmWorker"));
        coordinatesMap.put(HOUSING_COSTS,
                new ParsingCoordinate("homeExpensesAmount", "homeExpensesAmount"));
        coordinatesMap.put(UTILITY_EXPENSES_SELECTIONS,
                new ParsingCoordinate("utilityPayments", "payForUtilities"));
        coordinatesMap
                .put(APPLICANT_PROGRAMS, new ParsingCoordinate("choosePrograms", "programs"));
        coordinatesMap
                .put(HOUSEHOLD_PROGRAMS, new ParsingCoordinate("householdMemberInfo", "programs"));
        coordinatesMap.put(PREPARING_MEALS_TOGETHER,
                new ParsingCoordinate("preparingMealsTogether", "isPreparingMealsTogether"));
        coordinatesMap.put(IS_GOING_TO_SCHOOL,
                new ParsingCoordinate("goingToSchool", "goingToSchool"));
        coordinatesMap.put(WHO_IS_GOING_TO_SCHOOL,
                new ParsingCoordinate("whoIsGoingToSchool", "whoIsGoingToSchool"));
        coordinatesMap.put(IS_LOOKING_FOR_JOB,
                new ParsingCoordinate("jobSearch", "currentlyLookingForJob"));
        coordinatesMap.put(WHO_IS_LOOKING_FOR_A_JOB,
                new ParsingCoordinate("whoIsLookingForAJob", "whoIsLookingForAJob"));

        coordinatesMap.put(UNEARNED_INCOME,
                new ParsingCoordinate("unearnedIncome", "unearnedIncome"));
        coordinatesMap.put(UNEARNED_INCOME_CCAP,
                new ParsingCoordinate("unearnedIncomeCcap", "unearnedIncomeCcap"));
        coordinatesMap.put(HOME_EXPENSES,
                new ParsingCoordinate("homeExpenses", "homeExpenses"));
        coordinatesMap.put(UTILITY_PAYMENTS,
                new ParsingCoordinate("utilityPayments", "payForUtilities"));
        coordinatesMap.put(ASSETS_TYPE,
                new ParsingCoordinate("assets", "assets"));
        coordinatesMap.put(SAVINGS,
                new ParsingCoordinate("savings", "haveSavings"));
        coordinatesMap.put(RECEIVES_ENERGY_ASSISTANCE,
                new ParsingCoordinate("energyAssistance", "energyAssistance"));
        coordinatesMap.put(ENERGY_ASSISTANCE_OVER_20,
                new ParsingCoordinate("energyAssistanceMoreThan20", "energyAssistanceMoreThan20"));
        coordinatesMap.put(REGISTER_TO_VOTE,
                new ParsingCoordinate("registerToVote", "registerToVote"));
        coordinatesMap.put(HAVE_HEALTHCARE_COVERAGE,
                new ParsingCoordinate("healthcareCoverage", "healthcareCoverage"));
        coordinatesMap
                .put(PERSONAL_INFO_DOB, new ParsingCoordinate("personalInfo", "dateOfBirth"));
        coordinatesMap
                .put(PERSONAL_INFO_SSN, new ParsingCoordinate("personalInfo", "ssn"));
        coordinatesMap
                .put(PERSONAL_INFO_NO_SSN, new ParsingCoordinate("personalInfo", "noSSNCheck"));
        coordinatesMap
                .put(PERSONAL_INFO_FIRST_NAME, new ParsingCoordinate("personalInfo", "firstName"));
        coordinatesMap
                .put(PERSONAL_INFO_LAST_NAME, new ParsingCoordinate("personalInfo", "lastName"));

        coordinatesMap
                .put(HOUSEHOLD_INFO_DOB, new ParsingCoordinate("householdMemberInfo", "dateOfBirth"));
        coordinatesMap.put(HOUSEHOLD_INFO_FIRST_NAME,
                new ParsingCoordinate("householdMemberInfo", "firstName"));
        coordinatesMap.put(HOUSEHOLD_INFO_LAST_NAME,
                new ParsingCoordinate("householdMemberInfo", "lastName"));coordinatesMap.put(Field.HOUSEHOLD_INFO_RELATIONSHIP,
    ...
    coordinatesMap.put(Field.HOUSEHOLD_INFO_MARITAL_STATUS,
        ...
        coordinatesMap.put(MATCH_INFO_DOB, new ParsingCoordinate("matchInfo", "dateOfBirth"));
        coordinatesMap
                .put(MATCH_INFO_FIRST_NAME, new ParsingCoordinate("matchInfo", "firstName"));
        coordinatesMap.put(MATCH_INFO_LAST_NAME, new ParsingCoordinate("matchInfo", "lastName"));

        coordinatesMap.put(EVERYONE_US_CITIZENS, new ParsingCoordinate("usCitizen", "isUsCitizen"));
        coordinatesMap.put(WHO_ARE_NON_US_CITIZENS, new ParsingCoordinate("whoIsNonCitizen", "whoIsNonCitizen"));

        coordinatesMap.put(RACE_AND_ETHNICITY,
                new ParsingCoordinate("raceAndEthnicity", "raceAndEthnicity"));
        coordinatesMap.put(Field.HAS_HOUSE_HOLD,
        new ParsingCoordinate("addHouseholdMembers", "addHouseholdMembers"));groupCoordinatesMap.put(Group.JOBS, "jobs");
